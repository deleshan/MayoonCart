...
import { clearAdminOderDeleted, clearError } from "../../slices/orderSlice";
...
import {
  deleteAdminOrders,
  adminOrders as adminOrderAction,
...
export default function OrderList() {
  ...
  useEffect(() => {
    ...
    if (isAdminOrderDeleted) {
      toast("Order Deleted Successfully!", {
        type: "success",
        position: toast.POSITION.BOTTOM_CENTER,
        onOpen: () => dispatch(clearAdminOderDeleted()),
      });
      return;
    }
    dispatch(adminOrderAction);
  }, [dispatch, error, isAdminOrderDeleted]);
